...
wget https://downloads.haskell.org/~cabal/cabal-install-$CABAL_VERSION_TO_INSTALL/cabal-install-$CABAL_VERSION_TO_INSTALL-x86_64-ubuntu-16.04.tar.xz
tar -xf cabal-install-$CABAL_VERSION_TO_INSTALL-x86_64-ubuntu-16.04.tar.xz
rm cabal-install-$CABAL_VERSION_TO_INSTALL-x86_64-ubuntu-16.04.tar.xz cabal.sig
...
$HOME/.local/bin/cabal configure --with-compiler=ghc-$GHC_VERSION_TO_INSTALL
...
cp -p dist-newstyle/build/x86_64-linux/ghc-$GHC_VERSION_TO_INSTALL/cardano-node-$CARDANO_NODE_VERSION_TO_INSTALL/x/cardano-node/build/cardano-node/cardano-node $HOME/.local/bin/
cp -p dist-newstyle/build/x86_64-linux/ghc-$GHC_VERSION_TO_INSTALL/cardano-cli-$CARDANO_NODE_VERSION_TO_INSTALL/x/cardano-cli/build/cardano-cli/cardano-cli $HOME/.local/bin/
cd $HOME
